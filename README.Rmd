...
Note: This branch contains code for running models of recruit only foraging distances.

## Installation

You can install the released version of wagglefit from [CRAN](https://CRAN.R-project.org) with:
