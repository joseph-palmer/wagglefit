...
```{r, all-model-fits, fig.width=10,fig.height=11, fig.cap="Supplementary Fig 1. log Compliment cumulative frequency distribution of waggle dance durations and fits of the collective (red line) and individual (blue line) models for all 20 sites."}
