...
zoom_plt <- ggplot() +
  geom_sf(data = croped_data, fill = "#ededed", size = .1) +
  geom_sf(data = locations, aes(shape = model), size = 1.5) +
  geom_sf(data = selected_sites, aes(shape = site, size = 1)) +
