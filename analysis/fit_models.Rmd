...
This document contains code to fit the waggle dance model to each of our 20 different sites. The code here uses the wagglefit package, as well as some additional code stored in `fit_data.R` to help simplify things here. Each site has its own section, with reused code. The final sections create map plots and summary statistic plots.
...
theme_set(
  theme_classic() +
    theme(
      text = element_text(family = "DejaVuSerif", size = 8)
    )
)
library(cowplot)
library(dplyr)
...
```{r, BEL, include=FALSE, message = FALSE, warning = FALSE}
...
```{r, BFI, include=FALSE, message = FALSE, warning = FALSE}
...
# set coordinates for histogram subplot
subplot_coords <- c(0.5, 4.5, -6.5, -2.5)
...
```{r, BLO, include=FALSE, message = FALSE, warning = FALSE}
...
```{r, BUR, include=FALSE, message = FALSE, warning = FALSE}
...
```{r, CAD, include=FALSE, message = FALSE, warning = FALSE}
...
```{r, GIL, include=FALSE, message = FALSE, warning = FALSE}
...
```{r, HER, include=FALSE, message = FALSE, warning = FALSE}
...
```{r, HHS, include=FALSE, message = FALSE, warning = FALSE}
...
```{r, HOR, include=FALSE, message = FALSE, warning = FALSE}
...
```{r, MAK, include=FALSE, message = FALSE, warning = FALSE}
...
```{r, MEL, include=FALSE, message = FALSE, warning = FALSE}
...
```{r, MPA, include=FALSE, message = FALSE, warning = FALSE}
...
```{r, ROT, include=FALSE, message = FALSE, warning = FALSE}
...
```{r, SAU, include=FALSE, message = FALSE, warning = FALSE}
...
```{r, SOM, include=FALSE, message = FALSE, warning = FALSE}
...
```{r, SRA, include=FALSE, message = FALSE, warning = FALSE}
...
```{r, STU, include=FALSE, message = FALSE, warning = FALSE}
...
```{r, SWP, include=FALSE, message = FALSE, warning = FALSE}
...
```{r, YAL, include=FALSE, message = FALSE, warning = FALSE}
...
```{r, ZSL, include=FALSE, message = FALSE, warning = FALSE}
...
```{r, make-plots, include=FALSE, message = FALSE, warning = FALSE}
...
```{r, map-plots, include=FALSE, message = FALSE, warning = FALSE}
...
inset <- ggplot() +
  ...
  geom_point(
    data = map_data,
    aes(x = lon, y = lat, shape = model, colour = col), size = 1.5
  ) +
  geom_text(
    data = selected_sites, aes(x = lon, y = lat, label = label),
    nudge_x = c(0, -0.07), nudge_y = c(0.05, 0.05)
  ) +
...
sites_model_plot <- plot_grid(
  merge_plot_2, aic_plot, all_sites$STU$fit, all_sites$ZSL$fit,
  labels = c("A", "B", "C", "D")
)
...
```{r, other-map-plots, include=FALSE, message = FALSE, warning = FALSE}
# other map plots
inset <- ggplot() +
  geom_sf(
    data = worldmap,
