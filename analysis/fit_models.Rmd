...
This document contains code to fit the waggle dance model to each of our 20 different sites. The code here uses the wagglefit package, as well as some additional code stored in `fit_data.R` to help simplify things here.
...
# save results
saveRDS(df, file = "analysis/results/site_fit_results.Rda")
...
ggsave(
  plot = aic_plot,
  filename = "analysis/results/figures/AIC_plot.png",
  width = 90,
  height = 110,
  units = "mm",
  dpi = 300
...
ggsave(
  plot = ks_plot_dist,
  filename = "analysis/results/figures/sites_ks.png",
  width = 86,
  height = 180,
  units = "mm",
  dpi = 300
...
ggsave(
  ...
  filename = "analysis/results/figures/STU.png",
  width = 90,
  height = 110,
  units = "mm",
  dpi = 300
...
ggsave(
  ...
  filename = "analysis/results/figures/ZSL.png",
  width = 90,
  height = 110,
  units = "mm",
  dpi = 300
...
# london area
london <- st_read(
  "analysis/shapefiles/London_Ward.shp"
)
...
ggsave(
  plot = merge_plot,
  filename = "analysis/results/figures/site_map.png",
  width = 90,
  height = 110,
  units = "mm",
  dpi = 300
...
ggsave(
  ...
  filename = "analysis/results/figures/sites_model_plot.png",
  width = 183,
  height = 190,
  units = "mm",
  dpi = 300
...
ggsave(
  plot = sites_model_plot,
  filename = "analysis/results/figures/results_model_plot.png",
  width = 183,
  height = 190,
  units = "mm",
  dpi = 300
