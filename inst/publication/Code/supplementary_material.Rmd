...
# author: "Joseph Palmer, Ash Samuelson, Rich Gill, Elli Leadbeater and Vincent Jansen"
output:
  word_document
...
ggsave(
  "../results/figures/SI_figures/allsites_plot.png"
)
...
textable <- kbl(
  df2,
  caption = "Fit results for the fitting of the waggle dance model to each site.",
  booktabs = TRUE
  ) %>%
...
print(
  ...
  file = "../results/figures/SI_figures/fittable.tex"
)
